...
public class ConcurrentGetWhenPutTestCase extends TestCase {
	...
	public void testMain() throws Exception {
		...
		Set<String> expectedEndEvent = Tools.toSet("retrieved/key1/foo_value_1", "retrieved/key2/foo_value_1");
		assertEquals(expectedEndEvent, new HashSet<String>(events.subList(expectedEvents.size(), events.size())));
	}
}
